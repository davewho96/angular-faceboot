...
var PublicacionController = require('../controllers/post.controller');
...
api.get('/publications-user/:id/:page?', md_auth.ensureAuth, PublicacionController.getPublicationsByUser);
